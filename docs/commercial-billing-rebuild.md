...
surfaces as a B2B SaaS control path. Canonical list price is **$39 USD / month**
(annual **$390**). Paystack collects the USD price converted to NGN at the live
exchange rate (e.g. $39.00 at ₦1,322/USD → ₦51,558.00 / month). The 14-day
trial is unchanged.
...
4. **List price drift.** Product pricing had drifted to $19 / $190 in catalog tests,
   partner examples and e2e contracts while the intended commercial price is
   $39 / $390. NGN charges were already a separate published catalog and must
...
- **SSOT price:** `PLAN_PRICES_USD["pro"] = 39`, `PLAN_ANNUAL_PRICES_USD = 390`,
  `PLAN_AMOUNTS = 3900`, `PLAN_ANNUAL_AMOUNTS = 39000`.
...
`product_amount_minor=3900` for monthly Pro. Verify persists masked
...
- NGN charge was previously a separate published catalog (₦60,000 / ₦600,000);
  it is now the $39/$390 list price converted at the live FX rate
...
- Partner projections assume 0% churn and 30% of $39.
