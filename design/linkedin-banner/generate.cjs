...
const THEMES = {
  light: {
    bgTop: '#F7FAFC', bgMid: '#F2F6FA', bgBot: '#EBF1F7',
    eyebrow: '#3E7FB8', subText: '#5A6C82', bullet: '#2E9BCB',
    slateT1: '#2B3A4A', slateT2: '#4E6278',
    secT1: '#6FBBE2', secT2: '#2F7FBF', secGlow: '#7FC0E4', secGlowOp: 0.32,
    glowCyan: '#8FCBE8', glowCyanOp: 0.45, glowBlue: '#B9D4EC', glowBlueOp: 0.5,
    bigGlowOp: 0.5,
    gridMinor: 'rgba(80,105,135,0.05)', gridMajor: 'rgba(80,105,135,0.08)',
    hairline: 'rgba(70,95,125,0.12)',
    arcStroke: '#6482A5', arcOp: 0.16,
    panelStroke: 'rgba(70,100,135,0.18)', cardStroke: 'rgba(50,80,115,0.15)',
    panelSheen: 'rgba(255,255,255,0.85)',
    panel1: 0.6, panel2: 0.28, card1: 0.78, card2: 0.5,
    shadow: true,
    gpu1: '#A5D8EF', gpu2: '#5FA9D6', glyphStroke: '#5E738A',
    flow: '#7C99B8', bus: '#7FA6C8', busOp: 0.6, tapOp: 0.35,
    boundary: '#7C9CBF', boundaryOp: 0.8, dropOp: 0.3, boundaryLabel: '#647FA0',
    fadeCol: '#7A8FA6',
    ruleCol: '#2E9BCB',
    cyan: '#2E9BCB', cyanSoft: '#45AFDC', blue: '#4A84C4', green: '#35A97C',
    dotGray: '#8CA0B4',
    meta: '#9CACBE', metaDim: '#A3B4C6', cardHead: '#7C92A8',
    numFill: '#9DACBE', labelFill: '#33445A', subFill: '#75879D',
    metricText: '#6E86A0',
    chipFill: 'rgba(255,255,255,0.72)', chipStroke: 'rgba(60,90,120,0.24)', chipText: '#5E738A',
    haloFill: '#4E6E8E', haloStroke: '#F0F5FA',
    vignCol: '#33475E', vignOp: 0.06,
    grainConst: 0, grainOp: 0.032,
    frame: 'rgba(70,95,125,0.14)', tick: '#8CA2B8',
    photoFill: '#2E3E52', photoStroke: '#FFFFFF', photoText: '#B9C6D6', danger: '#C0654E',
  },
  dark: {
