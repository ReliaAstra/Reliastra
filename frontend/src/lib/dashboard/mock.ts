...
export const mockIncidents: Incident[] = [
  {
    ...
    evidence_status: 'generating',
    evidence_error: null,
    evidence_attempted_at: null,
  ...
  },
  {
    ...
    evidence_error: null,
    evidence_attempted_at: '2026-03-01T12:40:00.000Z',
    created_at: hours(18),
    updated_at: hours(17),
    display_id: 'INC-1801',
...
export const mockIncidentDetail: IncidentDetail = {
  ...
  timeline: [
    ...
    },
    {
      ...
      description: 'Confirmed by consecutive failed checks from the RELIASTRA observation point.',
    },
    {
      id: 't4',
      type: 'detection',
