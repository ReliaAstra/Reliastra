 ...
 *
 * A summary, not a second pricing page: plan, price, the four limits that
 * decide the choice, the amount actually charged, and one link to the full
 * terms. Deliberately three columns of type separated by rules — not three
 * glowing cards.
 *
        ...
        <div className="flex flex-col gap-6 pb-9 lg:flex-row lg:items-end lg:justify-between">
          <div className="flex flex-col gap-5">
            <p className="ob-label flex items-center gap-3">
              <span className="text-[var(--ob-signal)]">11</span>
          ...
          <p className="ob-body max-w-[44ch]">
            Every new organization starts on a 14-day Pro trial with attribution
            and evidence enabled. No payment method required.
          </p>
        </div>
