...
``app.modules.billing.pricing`` resolves what is charged, given an exchange rate.
...
from app.modules.billing.fx_reference import current_rate, fx_reference_payload
