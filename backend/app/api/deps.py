...
from app.platform.tenancy.roles import Role, has_permission
...
async def get_current_user(
    ...
    if raw_key:
        from app.platform.web.rate_limit import api_key_limiter, enforce_rate_limit
    ...
    if bearer and bearer.credentials:
        ...
        from app.platform.commercial.entitlements import Plan
        from app.platform.security.supabase import map_supabase_user, verify_supabase_token
        from app.modules.organizations.repository import OrganizationRepository
...
async def get_current_org(
    ...
    from app.platform.tenancy.middleware import extract_organization_id
    from app.modules.organizations.repository import OrganizationRepository
    ...
    if getattr(request.state, "auth_method", "") == "apikey":
        ...
        from app.platform.commercial.entitlements import PLAN_FEATURES, get_effective_plan_for_org
