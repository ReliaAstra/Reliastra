...
# ---------------------------------------------------------------------------
from app.platform.persistence.base import import_all_models
...
def _on_task_postrun(task_id=None, task=None, state=None, **extra):
    try:
        from app.platform.observability.metrics import celery_tasks_total
...
def _on_worker_process_init(**kwargs):
    ...
    try:
        from app.platform.persistence.session import reset_engine
